...
$_['text_login']                    = 'Логін';
$_['text_description']              = '<p>%s партнерська програма безкоштовна і дозволяє користувачам заробляти гроші, розміщуючи посилання на їхніх сайтах з рекламою %s або конкретним рептом. Будь-які покупки покупців, які натиснули на такі посилання, принесуть партнерам комісію від продажу. Стандартна комісія зараз складає %s.</p><p>Щоб отримати більше інформації відвідайте сторіну частих питань або перегляньте умови партнерської програми.</p>';
