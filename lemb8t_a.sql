...
-- Время создания: Ноя 09 2017 г., 10:04
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2017-11-09 09:31:32'),
...
(659, 0, 'config', 'config_tax_default', 'shipping', 0),
(660, 0, 'config', 'config_tax_customer', 'shipping', 0),
(661, 0, 'config', 'config_customer_online', '0', 0),
...
(667, 0, 'config', 'config_login_attempts', '5', 0),
(668, 0, 'config', 'config_account_id', '3', 0),
(669, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(670, 0, 'config', 'config_cart_weight', '1', 0),
(671, 0, 'config', 'config_checkout_guest', '1', 0),
(672, 0, 'config', 'config_checkout_id', '5', 0),
(673, 0, 'config', 'config_order_status_id', '1', 0),
(674, 0, 'config', 'config_processing_status', '[\"5\",\"1\",\"2\",\"12\",\"3\"]', 1),
(675, 0, 'config', 'config_complete_status', '[\"5\",\"3\"]', 1),
(676, 0, 'config', 'config_fraud_status_id', '7', 0),
(677, 0, 'config', 'config_api_id', '0', 0),
(678, 0, 'config', 'config_stock_display', '0', 0),
(679, 0, 'config', 'config_stock_warning', '0', 0),
(680, 0, 'config', 'config_stock_checkout', '0', 0),
(681, 0, 'config', 'config_affiliate_approval', '0', 0),
(682, 0, 'config', 'config_affiliate_auto', '0', 0),
(683, 0, 'config', 'config_affiliate_commission', '5', 0),
(684, 0, 'config', 'config_affiliate_id', '4', 0),
(685, 0, 'config', 'config_return_id', '0', 0),
(686, 0, 'config', 'config_return_status_id', '2', 0),
(687, 0, 'config', 'config_captcha', '', 0),
(688, 0, 'config', 'config_captcha_page', '[\"review\",\"return\",\"contact\"]', 1),
(689, 0, 'config', 'config_logo', 'catalog/logo.png', 0),
(690, 0, 'config', 'config_icon', 'catalog/cart.png', 0),
(691, 0, 'config', 'config_ftp_hostname', 'lemb8t.ftp.ukraine.com.ua', 0),
(692, 0, 'config', 'config_ftp_port', '21', 0),
(693, 0, 'config', 'config_ftp_username', 'lemb8t_a', 0),
(694, 0, 'config', 'config_ftp_password', 'bDCe72r3E6', 0),
(695, 0, 'config', 'config_ftp_root', '/', 0),
(696, 0, 'config', 'config_ftp_status', '1', 0),
(697, 0, 'config', 'config_mail_protocol', 'mail', 0),
...
(707, 0, 'config', 'config_seo_url', '1', 0),
...
(713, 0, 'config', 'config_encryption', '87431d38e7edce36d5153707d4cd2bf9', 0),
...
(658, 0, 'config', 'config_tax', '1', 0),
(657, 0, 'config', 'config_voucher_max', '1000', 0),
(656, 0, 'config', 'config_voucher_min', '1', 0),
(655, 0, 'config', 'config_review_guest', '1', 0),
(653, 0, 'config', 'config_limit_admin', '20', 0),
(654, 0, 'config', 'config_review_status', '1', 0),
(652, 0, 'config', 'config_product_count', '1', 0),
(651, 0, 'config', 'config_weight_class_id', '1', 0),
(650, 0, 'config', 'config_length_class_id', '1', 0),
(649, 0, 'config', 'config_currency_auto', '1', 0),
(648, 0, 'config', 'config_currency', 'USD', 0),
(647, 0, 'config', 'config_admin_language', 'ru-ru', 0),
(646, 0, 'config', 'config_language', 'ru-ru', 0),
(645, 0, 'config', 'config_zone_id', '3493', 0),
(644, 0, 'config', 'config_country_id', '220', 0),
(643, 0, 'config', 'config_comment', '', 0),
(642, 0, 'config', 'config_open', '', 0),
(641, 0, 'config', 'config_image', '', 0),
(640, 0, 'config', 'config_fax', '', 0),
(639, 0, 'config', 'config_telephone', '123456789', 0),
(638, 0, 'config', 'config_email', 'demo@opencart.com', 0),
(637, 0, 'config', 'config_geocode', '', 0),
(636, 0, 'config', 'config_address', 'Address 1', 0),
(635, 0, 'config', 'config_owner', 'Your Name', 0),
(634, 0, 'config', 'config_name', 'Your Store', 0),
(633, 0, 'config', 'config_layout_id', '4', 0),
(632, 0, 'config', 'config_theme', 'theme_default', 0),
(631, 0, 'config', 'config_meta_keyword', '', 0),
(630, 0, 'config', 'config_meta_description', 'My Store', 0),
(629, 0, 'config', 'config_meta_title', 'Your Store', 0),
(719, 0, 'config', 'config_error_filename', 'error.log', 0),
(748, 0, 'live_search', 'live_search_title_length', '100', 0),
(749, 0, 'live_search', 'live_search_description_length', '100', 0),
(750, 0, 'live_search', 'live_search_ajax_status', '1', 0),
(747, 0, 'live_search', 'live_search_image_height', '50', 0),
(746, 0, 'live_search', 'live_search_image_width', '50', 0),
(745, 0, 'live_search', 'live_search_limit', '5', 0),
(744, 0, 'live_search', 'live_search_show_description', '1', 0),
(743, 0, 'live_search', 'live_search_show_price', '1', 0),
(742, 0, 'live_search', 'live_search_show_image', '1', 0);
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=751;
