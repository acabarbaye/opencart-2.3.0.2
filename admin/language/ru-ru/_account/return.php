...
// Heading
$_['heading_title']      = 'Повернені рецепти';

// Text
$_['text_account']       = 'Обліковий запис';
$_['text_return']        = 'Інформація про повернення';
$_['text_return_detail'] = 'Деталі повернення';
$_['text_description']   = '<p>Якщо ви маєте проблеми з рецептом, які неможливо вирішити за допомогою технічної підтримки або відділу з продажів, ви можете повернути його назад. Для цього достатньо заповнити форму повернення. Ваш запит буде оброблено протягом трьох робочих днів.</p>
<p>Поверненню підлягають рецепти за умови збереження рецептного вигляду, наявності повної комплектації та оригінального пакування.</p>
<p>Зверніть увагу на групу рецептів, що не підлягають поверненню згідно до чинного законодавства.</p>';
$_['text_order']         = 'Інформація про замовлення';
$_['text_product']       = 'Інформація про  рецепти і причина повернення';
$_['text_reason']        = 'Reason for Return';
$_['text_message']       = '<p>Ваш запит на повернення рецепту успішно надіслано! Протягом 24 робочих годин ви отримаєте подальші інструкції.</p>';
...
$_['column_product']     = 'Назва рецепту';
...
$_['error_product']      = 'Назва рецепту повинна містити від 3 до 255 символів!';
